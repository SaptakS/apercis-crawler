...
def retrieve(terms):
	...
	se_url = "https://www.googleapis.com/customsearch/v1?q=%s&num=10&key=AIzaSyDmlM_YIQJb-UWVnKS_KxymNSPUAmij4Uc&cx=009773863468403510801:ljx2rcmuv8w" % join_terms
	try:
